...
type Mutation {
    ...
    setPlusOneStatus(guestId: String, taking: Boolean, firstName: String!, lastName: String!): Guest
    ...
    # Edits an invitation
    # ADMIN ONLY
    editInvitation(invitationId: Int, invitationName: String, houseNumber: String, streetAddress, String, aptNumber: String, city: String, state: String, zip: String): Invitation
